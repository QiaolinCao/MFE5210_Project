...
from trader.object import HistoryRequest, TickData, BarData
...
def get_datafeed() -> BaseDatafeed:
    ...
    if not datafeed_name:
        ...
        module_name: str = f"data.datafeed.{datafeed_name}"
        ...
        # Use base class if failed
            ...
            print(f"无法加载数据服务模块，请运行查看data.datafeed目录下，是否有{datafeed_name}.py")
