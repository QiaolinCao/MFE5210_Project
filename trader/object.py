...
from .constant import Interval, Exchange, OrderType, Direction, Offset, Status, Product, OptionType

ACTIVE_STATUSES = set(list([Status.SUBMITTING, Status.NOTTRADED, Status.PARTTRADED]))
...
class OrderData(BaseData):
    ...
    type: OrderType = OrderType.MARKET  # 在我的设定中，默认值为市价单
