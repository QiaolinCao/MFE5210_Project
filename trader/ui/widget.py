...
class TickMonitor(BaseMonitor):
    ...
    event_type: str = EventType.EVENT_TICK
...
class LogMonitor(BaseMonitor):
    ...
    event_type: str = EventType.EVENT_LOG
    data_key: str = ""
    sorting: bool = False
...
class TradeMonitor(BaseMonitor):
    ...
    event_type: str = EventType.EVENT_TRADE
    data_key: str = ""
    sorting: bool = True
...
class OrderMonitor(BaseMonitor):
    ...
    event_type: str = EventType.EVENT_ORDER
...
class PositionMonitor(BaseMonitor):
    ...
    event_type: str = EventType.EVENT_POSITION
...
class AccountMonitor(BaseMonitor):
    ...
    event_type: str = EventType.EVENT_ACCOUNT
...
class QuoteMonitor(BaseMonitor):
    ...
    event_type: str = EventType.EVENT_QUOTE
...
class TradingWidget(QtWidgets.QWidget):
    ...
    def register_event(self) -> None:
        ...
        self.event_engine.register(EventType.EVENT_TICK, self.signal_tick.emit)
