...
class BaseGateway(ABC):
    ...
    * on_contract
    ...
    # 接口所支持的交易所（我不太明白，为什么不是实例属性）
    exchanges: List[Exchange] = []

    def __int__(self, event_engine: EventEngine, gateway_name: str) -> None:
        """"""
        self.event_engine: EventEngine = event_engine
        self.gateway_name: str = gateway_name

    def on_event(self, e_type: str, data: Any = None):
        """
        General event push.
        """
        event: Event = Event(e_type, data)
    ...
    def on_tick(self, tick: TickData) -> None:
        ...
        self.on_event(EventType.TICK.value + tick.vt_symbol, tick)
    ...
    def on_trade(self, trade: TradeData) -> None:
        ...
        self.on_event(EventType.TRADE.value + trade.vt_symbol, trade)
    ...
    def on_order(self, order: OrderData) -> None:
        ...
        self.on_event(EventType.ORDER.value + order.vt_orderid, order)
    ...
    def on_position(self, position: PositionData) -> None:
        ...
        self.on_event(EventType.POSITION.value + position.vt_symbol, position)
    ...
    def on_account(self, account: AccountData) -> None:
        ...
        self.on_event(EventType.ACCOUNT.value + account.vt_accountid, account)
    ...
    def on_quote(self, quote: QuoteData) -> None:
        ...
        self.on_event(EventType.QUOTE.value + quote.vt_symbol, quote)
...
class LocalOrderManager:
    ...
    def get_local_orderid(self, sys_orderid: str) -> str:
        ...
        if not local_orderid:    # 如果为空字符串，即sys_orderid不在字典内
            # 生成新的localid，并添加映射关系
