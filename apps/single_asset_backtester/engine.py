"""
源自vnpy_ctabacktester及vnpy_ctastrategy
"""
...
from trader.utility import extract_vt_symbol, round_to
...
from data.datafeed.datafeed import BaseDatafeed, get_datafeed
from data.database.database import BaseDatabase, get_database

import strategies
from strategies import CtaTemplate, TargetPosTemplate


APP_NAME = "SingleAssetBacktester"
...
class BacktesterEngine(BaseEngine):
    ...
    def write_log(self, msg: str) -> None:
        ...
        log: LogData = LogData(msg=msg, gateway_name="single_asset_back_test")
        event: Event = Event(EVENT_BACKTESTER_LOG, log)
    ...
    def load_strategy_class(self) -> None:
        ...
        path1: Path = Path(strategies.__file__).parent
